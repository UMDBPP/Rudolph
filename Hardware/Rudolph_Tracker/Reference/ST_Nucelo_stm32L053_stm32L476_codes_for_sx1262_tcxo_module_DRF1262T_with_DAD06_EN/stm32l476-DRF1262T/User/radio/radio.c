...
const RadioLoRaBandwidths_t Bandwidths[] = {LORA_BW_250,LORA_BW_125, LORA_BW_062,LORA_BW_020,\
                                            LORA_BW_041,LORA_BW_015,LORA_BW_007,LORA_BW_500,\
                                            LORA_BW_031,LORA_BW_010,LORA_BW_500,LORA_BW_500,\
                                            LORA_BW_500,LORA_BW_500,LORA_BW_500,LORA_BW_500};
...
bool RadioIsChannelFree( RadioModems_t modem, uint32_t freq, int16_t rssiThresh, uint32_t maxCarrierSenseTime )
{
    ...
    carrierSenseTime = GET_TICK_COUNT( );

    // Perform carrier sense for maxCarrierSenseTime
    while( GET_TICK_COUNT()-carrierSenseTime< maxCarrierSenseTime )
    {
...
void RadioSetRxConfig( uint8_t modem, uint32_t bandwidth,
                         uint32_t datarate, uint8_t coderate,
                         uint32_t bandwidthAfc, uint16_t preambleLen,
                         uint16_t symbTimeout, bool fixLen,
                         uint8_t payloadLen,
...
void RadioSetTxConfig( uint8_t modem, int8_t power, uint32_t fdev,
                        uint32_t bandwidth, uint32_t datarate,
                        uint8_t coderate, uint16_t preambleLen,
                        bool fixLen, bool crcOn, bool freqHopOn,
                        uint8_t hopPeriod, bool iqInverted, uint32_t timeout )
